...
// Vallado SGP4 2016 numerical core; public-domain C# translation: https://github.com/aholinch/sgp4
// Vendored upstream source, kept close to upstream for auditability.
#pragma warning disable CS1717

using System;

#if ZEUS_PRODUCT_HOST
namespace Zeus.Product.Hosting.Satellites.Vallado
#else
namespace Zeus.Server.Satellites.Vallado
#endif
{
/*     ----------------------------------------------------------------
*
...
public class SGP4
{
	...
	private static double twopi = 2.0d*Math.PI;
	private static double deg2rad = pi / 180.0;

	public const int wgs72old = 1;
	public const int wgs72 = 2;
	public const int wgs84 = 3;
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	public static void dspace(double tc, ElsetRec rec)
	{
		int iretn;
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	public static void initl(double epoch, ElsetRec rec)
	{
		/* --------------------- local variables ------------------------ */
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	public static bool sgp4init
		(
		char opsmode,ElsetRec satrec
		)
	{
		/* --------------------- local variables ------------------------ */
		...
		double cc1sq,
			...
			xhdot1,qzms2t, ss, x2o3;
                double []r;
                double []v;
	        double delmotemp, qzms2ttemp, qzms24temp;
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	public static void getgravconst(int whichconst, ElsetRec rec)
	{
	...
	protected static double fmod(double numer, double denom)
	{
		long tquot = (long)Math.Floor(numer/denom);
